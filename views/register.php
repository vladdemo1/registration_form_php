...
<!-- <div class="cont">
    <?php 
    # $address = "https://www.google.com/maps/embed?pb=".$google_map_link;
        # echo '<iframe src=$address width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>';
    ?>
</div> -->
